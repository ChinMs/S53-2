...
class RoleController extends AdminController{
	...
	private $_admin_role = null; //用户--角色表数据库对象
	...
	//删除操作
	public function del(){
		if($this->_model->delete($_GET['id']) > 0 && $this->_admin_role->where(array('rid'=>$_GET['id']))->delete() > 0 && $this->_role_node->where(array('rid'=>array('eq',$_GET['id'])))->delete()>0){
